...
/**
 * Variante D – Footer wie auf der Live-Startseite. SEO-Ergänzung: der
 * Standort steht in einem semantischen <address>-Element, die Shop-Links
 * sind zusätzlich als Text verlinkt.
 */
