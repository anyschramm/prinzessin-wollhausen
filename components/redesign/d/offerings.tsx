...
/**
 * Variante D – Angebotsbereich wie auf der Live-Startseite (vier Karten).
 * SEO-Ergänzungen: ausführlichere Alt-Texte aus lib/site, ein zusätzlicher
 * beschreibender Satz pro Karte und ein Textlink zum Etsy-Shop.
 */
const liveCards = [
...
const cards = liveCards.flatMap(({ slug, description }) => {
  const product = products.find((p) => p.slug === slug)
  return product ? [{ ...product, description }] : []
})

export function OfferingsD() {
  return (
